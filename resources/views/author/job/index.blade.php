...
@section('content')
        ...
        <div class="account-bdy p-3">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div>
                        <form action="#" class="d-flex align-items-center" id="company-filter-form" style="gap: 20px;">
                            @csrf
                            <div class="me-3">
                                <select name="company" id="company" class="form-select" aria-label="Select a Company"
                                    style="padding: 10px 15px; font-size: 16px; border: 1px solid #ccc; border-radius: 8px; background-color: #f8f9fa; color: #495057; width: 100%; transition: all 0.3s ease;">
                                    <option value="" disabled selected>Select a Company</option>
                                </select>
                            </div>
                            <button type="submit" class="btn btn-info" style="display: flex; justify-content: center;"
                        ...
                        <div class="d-flex" style="gap: 20px;">
                            ...
                            <a href="{{ route('author.job.applications.pending') }}" class="btn btn-secondary me-3"
    ...
    <script>
        ...
        $('#company-filter-form').submit(function(e) {
            ...
            if (selectedCompany) {
                // You can now use the selected company ID to filter results
                alert('Selected Company ID: ' + selectedCompany);
            }
        });
    </script>
