            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="footer-links">
                        ...
                        <div class="footer-link-list">
                            <a href="#" class="footer-links"><i class="fas fa-compass"></i> New Baneshwor,
                                Kathmandu, Nepal</a>
                            <a href="tel:98400001511" class="footer-links"><i class="fas fa-phone"></i>
                                +977-1-4596122</a>
                            <a href="mailto:info@cambridgeinfotech.com.np" class="footer-links"><i
                                    class="fas fa-envelope"></i> info@cambridgeinfotech.com.np</a>
                            <div class="social-links">
                                <a href="https://www.facebook.com/cambridgeinfotech.com.np" target="_blank"
                                    class="social-link"><i class="fab fa-facebook"></i></a>
                                <a href="https://twitter.com/CambridgeNepal" target="_blank" class="social-link"><i
                                        class="fab fa-twitter"></i></a>
                                <a href="https://goo.gl/maps/3KKDLKX7YVrXtLZq5" target="_blank" class="social-link"><i
